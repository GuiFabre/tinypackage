...
') %>% write_lines(.,file = paste0(to,"/temp_bookdown_report/file/bookdown-template-master/_bookdown.yml"), append = FALSE)
...
') %>% write_lines(.,file = paste0(to,"/temp_bookdown_report/file/bookdown-template-master/style.css"), append = FALSE)
...
') %>% write_lines(.,file = paste0(to,"/temp_bookdown_report/file/bookdown-template-master/index.Rmd"), append = FALSE)
